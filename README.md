...
clustering_results<-MPLNClustering(dataset=testing_dataset, Gmin=1, Gmax=5, n_chains=3, n_iterations=1000, membership=NA, init_method="kmeans", n_init_iterations=5, normalize="TMM")
