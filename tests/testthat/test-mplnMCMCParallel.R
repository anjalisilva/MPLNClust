...
test_that("Checking clustering results", {
  ...
  expect_that(mplnMCMCResults$initalization_method, equals("kmeans"))
  numPara <- c(27)
  expect_that(mplnMCMCResults$numb_of_parameters, equals(numPara))
  expect_that(mplnMCMCResults$true_labels, equals(simulatedCounts$trueMembership))
  expect_that(trunc(mplnMCMCResults$ICL_all$ICLmodelselected), equals(2))
  expect_that(trunc(mplnMCMCResults$AIC_all$AICmodelselected), equals(2))
  expect_that(trunc(mplnMCMCResults$BIC_all$BICmodelselected), equals(2))
})
